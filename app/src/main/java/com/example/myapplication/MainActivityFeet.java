...
public class MainActivityFeet extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_feet);
    ...
    public void onClick(View v){
        ...
        else if(v.equals(bdot)) txtFrom.append("Z");
        ...
        if(v.equals(bconvert)){
            try {
                String valueMeter = txtFrom.getText().toString();
                double feet = Double.parseDouble(valueMeter);
                feet = (feet * 3.28);
                txtTo.setText(String.valueOf(feet));
            }
