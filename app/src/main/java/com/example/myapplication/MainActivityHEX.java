...
public class MainActivityHEX extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v){
        ...
        if(v.equals(bconvert)){
            try {
                String valueDECIMAL = txtFrom.getText().toString();
                int hex = Integer.parseInt(valueDECIMAL);

                txtTo.setText(Integer.toHexString(hex).toUpperCase(Locale.ROOT));
            }
