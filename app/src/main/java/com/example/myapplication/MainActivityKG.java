...
public class MainActivityKG extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_kg);
    ...
    public void onClick(View v){
        ...
        if(v.equals(bconvert)){
            try {
                String valueKG = txtFrom.getText().toString();
                double pounds = Double.parseDouble(valueKG);
                pounds = (pounds * 2.204);
                txtTo.setText(String.valueOf(pounds));
            }
