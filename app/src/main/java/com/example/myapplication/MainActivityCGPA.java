...
public class MainActivityCGPA extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_cgpa);
    ...
    public void onClick(View v){
        ...
        if(v.equals(bconvert)){
            try {
                ...
                double percent = Double.parseDouble(valueCGPA);
                percent = (percent * 9.1);
                txtTo.setText(String.valueOf(percent));
            }
